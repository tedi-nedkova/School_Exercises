        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Couriers_Vehicles_OfficeId",
                        column: x => x.OfficeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CouriersVehicle", x => new { x.CourierId, x.VehicleId });
                    table.ForeignKey(
                        name: "FK_CouriersVehicle_Couriers_CourierId",
                        column: x => x.CourierId,
                        principalTable: "Couriers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_CouriersVehicle_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CouriersVehicle_VehicleId",
                table: "CouriersVehicle",
                column: "VehicleId");
